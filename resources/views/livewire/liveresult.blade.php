    ...
    <div style="width:380px; height: 900px; border:2px solid gold; padding-top:10px; padding-bottom:10px;margin:auto;">
        ...
        <div class="d-flex justify-content-around mt-3">
            <div style="width:200px;">
                <label for="" class="col-form-label" style="font-family: 'Sura', serif; font-size:30px; padding-left:20px;" >1st Prize</label>
            </div>
            <div wire:poll style="padding-right:25px;width:200px;">
                <input type="text" class="form-control" style="font-size:30px; border-radius:25px; text-align: center; font-weight:bold; letter-spacing: 3px;" value="{{ $liveresult->pluck('sh1')->first() }}" name="hadiahutamasatu" id="" placeholder=""  maxlength="4" readonly>
            </div>
        </div>
        <div class="d-flex mt-3 justify-content-around">
            <div style="width:200px;">
                <label for="" class="col-form-label" style="font-family: 'Sura', serif; font-size:30px; padding-left:20px;"  >2nd Prize</label>
            </div>
            <div wire:poll style="padding-right:25px;width:200px;">
                <input  type="text" class="form-control" style="font-size:30px; border-radius:25px; text-align: center; font-weight:bold; letter-spacing: 3px;" value="{{ $liveresult->pluck('sh2')->first() }}" name="hadiahutamasatu" id="" placeholder="" maxlength="4" readonly>
            </div>
        </div>
        <div class="d-flex mt-3 justify-content-around">
            <div style="width:200px;">
            ...
            <div wire:poll style="padding-right:25px;width:200px;">
                <input  type="text" class="form-control" style="font-size:30px; border-radius:25px; text-align: center; font-weight:bold; letter-spacing: 3px;" name="hadiahutamasatu" value="{{$liveresult->pluck('sh3')->first()}}" id="" placeholder="" maxlength="4" readonly>
            </div>
        </div>
