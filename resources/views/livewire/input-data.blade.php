            ...
            <div class="card {{ $nomor }}">
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-6">
                            <label for="Total" class="col-form-label">{{ number_format($datainvoicetemp->sum('amount'),2) }}</label>
                        </div>
                    </div>
                    <div class="row mt-1">
                        <div class="col-6">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-6">
                            <label for="GrandTotal" class="col-form-label text-danger font-weight-bold" >{{ number_format($datainvoicetemp->sum('total'),2) }}</label>
                        </div>
                    </div>
                    <div class="row mt-1">
                        <div class="col-6">
