...
class Omset extends Component
{
    ...
    {
        $empatangka = \DB::table('invoice_details')->select('kode','posisi','data',\DB::raw('sum(amount) as total'))->where('result_id', $this->dataid)->groupBy('kode','posisi','data')->orderBy('total','Desc')->paginate(12);
